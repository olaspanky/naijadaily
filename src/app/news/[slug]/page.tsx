      ...
      try {
        ...
        if (result.success && result.data) {
          ...
          if (article) {
            ...
            // Record view when article is loaded
  ...
  if (error || !newsItem) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <p className="text-xl font-serif text-red-600">{error || "Article not found"}</p>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Nigeria's most comprehensive and trusted online newspaper delivering breaking news, politics, business, entertainment, sports, and more.
              </p>
              <div className="flex space-x-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/advertise" className="text-gray-400 hover:text-white">Advertise With Us</Link></li>
              </ul>
            </div>
            <div>
